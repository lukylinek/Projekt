...
Cíle projektu:
- Získávání obrazu z webkamery pomocí knihovny OpenCV.  
- Detekce pohybu porovnáváním aktuálního snímku s pozadím.
- Možnost ukládání snímků při detekci pohybu do nejake složky  
- Ovládání aplikace z klávesnice napr. ukončení
